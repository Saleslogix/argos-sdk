...
export default class ApplicationModule {
  ...
  static get customizationsLoaded() {
    return (ApplicationModule as any)._customizationsLoaded;
  }

  static set customizationsLoaded(value) {
    (ApplicationModule as any)._customizationsLoaded = value;
  }

  static get viewsLoaded() {
    return (ApplicationModule as any)._viewsLoaded;
  }

  static set viewsLoaded(value) {
    (ApplicationModule as any)._viewsLoaded = value;
  }

  static get toolbarsLoaded() {
    return (ApplicationModule as any)._toolbarsLoaded;
  }

  static set toolbarsLoaded(value) {
    (ApplicationModule as any)._toolbarsLoaded = value;
  }
  /**
  ...
  loadCustomizations() {
    if (ApplicationModule.customizationsLoaded) {
      console.warn('Multiple calls to loadCustomizations detected. Ensure your customization is not calling this.inherited from loadCustomizations in the ApplicationModule.'); // tslint:disable-line
      return;
    }
  ...
  loadViews() {
    if (ApplicationModule.viewsLoaded) {
      console.warn('Multiple calls to loadViews detected. Ensure your customization is not calling this.inherited from loadViews in the ApplicationModule.'); // tslint:disable-line
      return;
    }
  ...
  loadToolbars() {
    if (ApplicationModule.toolbarsLoaded) {
      console.warn('Multiple calls to loadToolbars detected. Ensure your customization is not calling this.inherited from loadToolbars in the ApplicationModule.'); // tslint:disable-line
      return;
    }
