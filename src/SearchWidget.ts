 ...
 * 2\. `#!Name eq 'John'` - The `Name eq 'John'` will be inserted directly,
 * avoiding {@link List#formatSearchQuery formatSearchQuery}. This is a "custom expression".
 *
 * Multiple hashtags is supported as well as hashtags with
 * additional text that gets sent through {@link List#formatSearchQuery formatSearchQuery}.
 *
 ...
 *
 * See the [Defining Hash Tags guide](#!/guides/v2_beyond_the_guide_defining_hashtags)
 * for more information and how it supports localization.
...
const __class = declare('argos.SearchWidget', [_WidgetBase, _Templated], {
  ...
  widgetTemplate: new Simplate([
    ...
    '<input type="text" placeholder="{%= $.searchText %}" name="query" class="searchfield" autocorrect="off" autocapitalize="off" data-dojo-attach-point="queryNode" data-dojo-attach-event="onkeypress:_onKeyPress" />', // tslint:disable-line
