...
__class = declare('argos.Calendar', [View], {
    ...
    months: null,
    dateFormat: (<any>moment().lang())._longDateFormat.L,
    timeFormatText: 'h:mm A',
    is24hrTimeFormat: (<any>moment().lang())._longDateFormat.LT.match(/H\:/),
    date: false,
    ...
    init: function() {
        ...
        this.dateFormat = (<any>moment().lang())._longDateFormat.L;
        this.is24hrTimeFormat = (<any>moment().lang())._longDateFormat.LT.match(/H\:/);
