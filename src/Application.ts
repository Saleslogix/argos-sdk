...
(Function.prototype as any).bindDelegate = function bindDelegate(scope) {
  const self = this;
...
export default class Application {
   ...
   */
  registerService(name, service, options: any = {}) {
   ...
   * @param {Object} options Optional settings for the registered service.
   */
  registerConnection(name, definition, options: any = {}) {
