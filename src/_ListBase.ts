...
import win = require('dojo/window');
...
import SearchWidget = require('./SearchWidget');
import ConfigurableSelectionModel = require('./ConfigurableSelectionModel');
import _PullToRefreshMixin = require('./_PullToRefreshMixin');
...
var __class = declare('argos._ListBase', [View, _PullToRefreshMixin], {
    ...
    */
    ...
    ensureQuickActionPrefs: function() {
        var appPrefs, actionPrefs, filtered:any[];
