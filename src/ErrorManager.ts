...
export default class ErrorManager {
   ...
   */
  extractFailureResponse(response) {
  ...
  showErrorDialog(title, message, onOkay) {
...
lang.setObject('argos.ErrorManager', ErrorManager);
