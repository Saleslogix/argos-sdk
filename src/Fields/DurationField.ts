...
const control = declare('argos.Fields.DurationField', [LookupField], {
  ...
  widgetTemplate: new Simplate([
    ...
    '<input data-dojo-attach-point="inputNode" data-dojo-attach-event="onkeyup: _onKeyUp, onblur: _onBlur, onfocus: _onFocus" class="" type="{%: $.inputType %}" name="{%= $.name %}" {% if ($.readonly) { %} readonly {% } %}>', // tslint:disable-line
    '</div>',
  ]),
  iconClass: 'more',
