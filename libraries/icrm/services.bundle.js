...
var PickListService = exports.PickListService = function () {
  ...
  _createClass(PickListService, [{
    ...
    value: function getFirstByKey(key, isId, callback, onError) {
      ...
      var cachedResult = useCache ? this._storage.getItem(this._storageNameSpace, key + '_' + config.language) : null;
      if (cachedResult) {
        ...
        return {
          ...
          handlers: {
            success: function success(result) {
              ...
              if (useCache) {
                _this._storage.setItem(_this._storageNameSpace, key + '_' + config.language, result);
              }
