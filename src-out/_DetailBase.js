define(["require", "exports", 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/Deferred', 'dojo/query', 'dojo/dom', 'dojo/dom-class', 'dojo/dom-construct', './Format', './Utility', './ErrorManager', './View'], function (require, exports, declare, lang, Deferred, query, dom, domClass, domConstruct, format, utility, ErrorManager, View) {
    /**
