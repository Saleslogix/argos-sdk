define(["require", "exports", 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/string', 'dojo/dom-class', '../Format', './LookupField', '../FieldManager'], function (require, exports, declare, lang, string, domClass, format, LookupField, FieldManager) {
    /**
