define(["require", "exports", 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/dom-attr', 'dojo/dom-class', './_Field', '../FieldManager'], function (require, exports, declare, lang, domAttr, domClass, Field, FieldManager) {
    /**
