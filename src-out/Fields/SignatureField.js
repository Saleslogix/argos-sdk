define(["require", "exports", 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/json', 'dojo/dom-attr', '../Format', './EditorField', '../FieldManager'], function (require, exports, declare, lang, json, domAttr, format, EditorField, FieldManager) {
    /**
